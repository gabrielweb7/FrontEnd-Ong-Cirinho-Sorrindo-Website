...
$(function() { 
	...
	/* Footer Parceiros Logo Slider Carrousel */
	if($(".footerParceiros .owl-carousel").length) { 
		$(".footerParceiros .owl-carousel").owlCarousel({
			items: 3,
			loop:false,
			autoplay:true,
			margin: 30,
	...
	/* widgetGaleriaDeImagens Slider Carrousel */
	if($(".widgetGaleriaDeImagens .owl-carousel").length) { 
		$(".widgetGaleriaDeImagens .owl-carousel").owlCarousel({
			items: 5,
			loop:false,
			autoplay:true,
			margin: 30,
